...
export default function Header({ metadata, layerCount }: HeaderProps) {
  ...
  return (
    <>
      <h1 className="text-3xl tracking-tight mb-1 bg-[linear-gradient(to_right,#D04A02_0%,#D04A02_10%,white_100%)] bg-clip-text text-transparent" style={{ fontFamily: '"Arial Black", "Arial Bold", Gadget, sans-serif', fontWeight: 900 }}>Intelligent Customer Edge Capability Blueprint</h1>
      <p className="text-xs text-tx3 mb-5">
        Explore, assess, and plan your intelligent customer edge capabilities
      </p>
