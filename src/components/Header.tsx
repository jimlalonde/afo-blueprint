...
export default function Header({ metadata, layerCount }: HeaderProps) {
  ...
  return (
    <>
      <h1 className="text-3xl tracking-tight mb-1 bg-[linear-gradient(to_right,#CF202F_0%,#CF202F_10%,white_100%)] bg-clip-text text-transparent" style={{ fontFamily: '"Arial Black", "Arial Bold", Gadget, sans-serif', fontWeight: 900 }}>Agentic Front Office (AFO) Capability Blueprint</h1>
